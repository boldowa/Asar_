...
#  define malloc(type, count) (type*)cpputest_malloc_location(sizeof(type)*(count), __FILE__, __LINE__)
#  define realloc(val, type, count) (type*)cpputest_realloc_location(val, sizeof(type)*(count), __FILE__, __LINE__)
#else
