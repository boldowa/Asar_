...
g++ -fPIC -std=c++98 -fPIC -Wall -Werror -Wno-unused-result -Wno-uninitialized *.cpp -olibasar.so -g -fno-rtti -DINTERFACE_LIB -Dstricmp=strcasecmp -Dlinux -DRELEASE -shared
